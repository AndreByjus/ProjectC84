...
function my_keydown(e)
{
	...
	console.log(keyPressed);
		...
		if((keyPressed >=97 && keyPressed<=122)|| (keyPressed >=65 && keyPressed<=90))
		{
			...
			numberkey();
			document.getElementById("d1").innerHTML="Você pressionou uma tecla de números";
		}

		else if((keyPressed >=37 && keyPressed<=40)){
			arrowkey();
			document.getElementById("d1").innerHTML="Você pressionou uma tecla de direção";
		}
			...
			otherkey();
			document.getElementById("d1").innerHTML="Você pressionou uma tecla de símbolos ou outros";
		}
